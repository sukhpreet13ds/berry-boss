...
import { fetchNewsList } from '../lib/queries';
...
export default function News({ newsList }) {
  return (
    <>
      <Head>
        <title>Berry Boss - Farm Updates &amp; Fresh Harvest News</title>
        <meta
          name="description"
          content="Stay up to date with the latest Berry Boss news, seasonal harvests, farm updates, community initiatives, and fresh fruit announcements."
        />
        <meta
          name="keywords"
        ...
        <div className="hero-container">
          ...
          <section className="hero-content">
            ...
            <div className="hero-image-container">
              <img src="/assets/news-bg.jpg" alt="Strawberry Field" className="hero-image" decoding="async" />
            </div>
          </section>
        </div>
      </div>
